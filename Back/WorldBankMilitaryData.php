...
$url = 'https://api.worldbank.org/v2/country/'.$requested_country.'/indicator/MS.MIL.XPND.GD.ZS?format=json&mrnev=5';
...
$output['status']["name"] = "military expenditure";
$output["data"] = $militaryExpenditure;
