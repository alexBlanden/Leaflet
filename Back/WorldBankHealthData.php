...
$url = 'https://api.worldbank.org/v2/country/'.$requested_country.'/indicator/SH.XPD.CHEX.GD.ZS?format=json&mrnev=5';
...
$output['status']["name"] = "health expenditure";
$output["data"] = $healthExpenditure;
